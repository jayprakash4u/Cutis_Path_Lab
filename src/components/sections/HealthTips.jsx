...
const tips = [
  {
    ...
    icon: (
      <svg viewBox="0 0 164 164" xmlns="http://www.w3.org/2000/svg">
        <circle cx="82" cy="82" r="60" fill="#f0f9ff" stroke="#4a9aba" strokeWidth="2"/>
        <line x1="62" y1="55" x2="62" y2="65" stroke="#4a9aba" strokeWidth="2" strokeLinecap="round"/>
        <line x1="67" y1="55" x2="67" y2="65" stroke="#4a9aba" strokeWidth="2" strokeLinecap="round"/>
        <path d="M62 65 Q65 70 67 65" fill="none" stroke="#4a9aba" strokeWidth="2" strokeLinecap="round"/>
        <line x1="64" y1="68" x2="64" y2="110" stroke="#4a9aba" strokeWidth="2.5" strokeLinecap="round"/>
        <line x1="74" y1="55" x2="74" y2="110" stroke="#4a9aba" strokeWidth="2.5" strokeLinecap="round"/>
        <path d="M74 55 Q82 65 74 78" fill="#4a9aba" stroke="#4a9aba" strokeWidth="1"/>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 164 164" xmlns="http://www.w3.org/2000/svg">
        <circle cx="82" cy="82" r="60" fill="#f0f9ff" stroke="#4a9aba" strokeWidth="2"/>
        <path d="M82 45 C82 45 62 70 62 85 C62 98 71 108 82 108 C93 108 102 98 102 85 C102 70 82 45 82 45 Z" fill="#4a9aba" opacity="0.85"/>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 164 164" xmlns="http://www.w3.org/2000/svg">
        <circle cx="82" cy="82" r="60" fill="#f0f9ff" stroke="#4a9aba" strokeWidth="2"/>
        <path d="M68 55 L96 55 L88 82 Q88 92 82 92 Q76 92 76 82 Z" fill="#4a9aba" opacity="0.15" stroke="#4a9aba" strokeWidth="2"/>
        <path d="M70 68 L94 68 L88 82 Q88 90 82 90 Q76 90 76 82 Z" fill="#4a9aba" opacity="0.3"/>
        <line x1="82" y1="92" x2="82" y2="108" stroke="#4a9aba" strokeWidth="2" strokeLinecap="round"/>
        <line x1="72" y1="108" x2="92" y2="108" stroke="#4a9aba" strokeWidth="2.5" strokeLinecap="round"/>
    ...
    <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-10">
          <span className="inline-block px-4 py-1.5 bg-sky-600 text-white text-sm font-semibold rounded-md mb-3">
            Preparation Tips
          </span>
          ...
          <p className="text-sm text-slate-500 max-w-xl mx-auto">
            Follow these guidelines before your health checkup for accurate results
          </p>
        </div>
