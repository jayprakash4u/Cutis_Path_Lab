...
export function BuildingIcon({ size = 24, className = '' }) {
  return (
    ...
    >
      ...
      <rect x="6" y="6" width="2" height="2.5" fill="#C0431B" />
      <rect x="12" y="6" width="2" height="2.5" fill="#C0431B" />
      <rect x="6" y="14" width="2" height="2.5" fill="#C0431B" />
      <rect x="12" y="14" width="2" height="2.5" fill="#C0431B" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <circle cx="12" cy="9" r="1.5" fill="#C0431B" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <path d="M17 12c0-.55.45-1 1-1s1 .45 1 1" stroke="#C0431B" strokeWidth="2" fill="none" />
    </svg>
  );
}
...
export function EmailIcon({ size = 24, className = '' }) {
  return (
    ...
    >
      ...
      <path d="M6 10l4 3 4-3" stroke="#C0431B" strokeWidth="1.5" fill="none" strokeLinecap="round" />
    </svg>
  );
}
...
export function InstagramIcon({ size = 24, className = '' }) {
  return (
    ...
    >
      ...
      <circle cx="17.5" cy="6.5" r="1" fill="#C0431B" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <circle cx="12" cy="12" r="1.5" fill="#C0431B" />
    </svg>
  );
}
